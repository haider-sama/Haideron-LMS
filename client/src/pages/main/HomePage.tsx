                ...
                <header className="space-y-6">
                    {isLoggedIn && user ? (
                        ...
                        <>
                            ...
                            <p className="text-muted dark:text-darkTextSecondary text-lg sm:text-xl max-w-2xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
                                <Link to="/register" className="w-full sm:w-auto">
                                    <button
                                        className={getButtonClass({
                                            ...
                                            hoverBg: "hover:bg-secondary dark:hover:bg-darkBlurpleHover",
                                ...
                                <Link to="/login" className="w-full sm:w-auto">
                                    <button
                                        className={getButtonClass({
                                            bg: "bg-surface dark:bg-darkSurface",
                                            ...
                                            focusRing: "focus:ring-4 focus:ring-gray-200 dark:focus:ring-darkBorderLight",
                                            extra: "w-full text-sm px-5 py-2 transition-all duration-200 font-medium rounded border border-muted dark:border-darkBorderMuted flex items-center justify-center gap-2",
                                        })}
                                    >
