    ...
    return (
        <div className="flex min-h-screen bg-white dark:bg-darkPrimary px-4 py-8">
            ...
            <div className="flex-1 flex justify-center items-center">
                <form
                    onSubmit={onSubmit}
                    className="w-full max-w-sm bg-gray-100 border border-gray-300 dark:bg-darkSurface dark:border-darkBorderLight p-8 rounded-sm flex flex-col gap-4 shadow-sm"
                >
                    {/* Heading + Register */}
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center border border-gray-300 dark:border-darkBorderLight rounded px-3 bg-white dark:bg-darkSurface mt-1">
                            ...
                            <input
                                type="email"
                                placeholder="Email"
                                className="w-full p-2 bg-transparent outline-none text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-darkTextMuted"
                                required
                    ...
                    {/* Login Button */}
                    <Button isLoading={isLoggingIn} loadingText="Logging in..." fullWidth={true}
                    size="lg">
                        Login
                    </Button>
