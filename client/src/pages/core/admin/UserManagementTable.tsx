...
const UserManagementTable: React.FC = () => {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            <div className="overflow-x-auto border rounded-md border-gray-300 bg-white dark:bg-darkSurface dark:border-darkBorderLight">
                                ...
                                >
                                    <td className="px-4 py-2">
                                        {user.avatarURL ? (
                                            ...
                                            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 dark:bg-darkMuted text-gray-700 dark:text-darkTextSecondary text-sm font-semibold">
