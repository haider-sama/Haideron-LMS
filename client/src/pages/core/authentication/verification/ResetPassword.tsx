					...
					<form onSubmit={handleSubmit}>
						...
						<button
							...
							className={`${getButtonClass({
								...
								focusRing: "focus:ring-4 focus:ring-gray-200 dark:focus:ring-darkBlurple/40",
								disabled: isLoading,
								extra: "w-full text-sm px-4 py-2 font-medium border border-gray-200 dark:border-darkBorderLight rounded-lg transition-all duration-200",
							})}`}
						>
