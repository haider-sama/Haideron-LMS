...
// import { FiEdit3, FiFileText, FiThumbsUp, FiTrash2, FiUser } from "react-icons/fi";
...
//     const { isOwner, canManage, isLoggedIn } = usePermissions({ authorId: author?._id });
...
//                 <Link
//                     to={`/forums/profile/${author?.username || author?._id}`}
