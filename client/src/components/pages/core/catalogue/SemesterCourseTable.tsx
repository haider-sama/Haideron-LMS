...
// import { MultiSelectOption } from "../../../../account/Input";
// import {
//     deleteSemester,
//     getAllCourses,
//     getSemestersByCatalogue,
// } from "../../../../../api/lms/faculty/semesterApi";
// import { Semester } from "../../../../../constants/lms/interfaces";
...
// const SemesterCourseTable: React.FC<Props> = ({ catalogueId }) => {
...
//         ["semesters", catalogueId],
//         () => getSemestersByCatalogue(catalogueId).then((res) => res.semesters),
//         { enabled: !!catalogueId }
//     );

//     const { data: allCourses = [] } = useQuery(["allCourses"], () =>
//         getAllCourses({ page: 1, limit: 100 }).then((res) => res.courses)
//     );

//     const toggleExpand = (id: string) => {
//         setExpandedSemesterId((prev) => (prev === id ? null : id));
//         setSelectedCourseIds([]); // Clear selection as array
//     };

//     const deleteSemesterMutation = useMutation(
//         (id: string) => deleteSemester(id),
//         {
//             onSuccess: () => {
...
//     if (loadingSemesters) return <TopCenterLoader />;
...
//                                 const isExpanded = expandedSemesterId === sem._id;
...
//                                         <tr
//                                             key={sem._id}
//                                             className="border-b hover:bg-gray-50 dark:hover:bg-darkMuted transition border-gray-200 dark:border-darkBorderLight"
//                                         >
...
//                                                     <button
//                                                         onClick={() => {
//                                                             const first = window.confirm("Are you sure you want to delete this semester?");
//                                                             if (!first) return;
//                                                             const second = window.confirm("This action is irreversible. Confirm delete?");
//                                                             if (!second) return;
//                                                             deleteSemesterMutation.mutate(sem._id);
//                                                         }}
...
//                                                     <CourseList semester={sem} allCourses={allCourses} catalogueId={catalogueId} />
//                                                 </td>
//                                             </tr>
//                                         )}
//                                     </>
