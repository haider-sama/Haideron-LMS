    ...
    return (
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    <motion.div
                        className="relative bg-white text-gray-800 rounded-2xl shadow-xl w-full max-w-5xl mx-4 flex flex-col"
                        initial="hidden"
                        animate="visible"
                        exit="exit"
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row flex-1 overflow-hidden max-h-[80vh]">
                            {/* Sidebar */}
                            <aside className="w-full md:w-64 bg-gray-100 border-b md:border-b-0 md:border-r border-gray-200 p-4 overflow-y-auto max-h-48 md:max-h-none">
                            ...
                            {/* Main Content */}
                            <main className="flex-1 p-6 overflow-y-auto max-h-[calc(80vh-6rem)] md:max-h-[70vh] scrollbar-thin scrollbar-thumb-gray-300">
