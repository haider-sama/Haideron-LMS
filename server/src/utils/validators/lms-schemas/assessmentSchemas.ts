import { z } from 'zod';
import { AssessmentTypeEnum, ClassSectionEnum, FinalizedResultStatusEnum } from '../../../shared/enums';
...
export const CreateAssessmentSchema = z.object({
    ...
    clos: z
        .array(z.string().uuid({ message: "Invalid CLOs ID" }))
...
export const saveGradingSchemeSchema = z.object({
    section: z.nativeEnum(ClassSectionEnum, { required_error: "Section is required." }),
